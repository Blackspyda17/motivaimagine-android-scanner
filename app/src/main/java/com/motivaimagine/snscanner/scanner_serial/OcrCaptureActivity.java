...
public final class OcrCaptureActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (ContextCompat.checkSelfPermission(OcrCaptureActivity
                        .this,
                Manifest
                        .permission
                        .CAMERA)
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(OcrCaptureActivity
                            .this,
                    Manifest
                            .permission
                            .CAMERA)) {
                ...
                ActivityCompat.requestPermissions(OcrCaptureActivity
                                .this,
        ...
        try {
            if (ActivityCompat.checkSelfPermission(OcrCaptureActivity.this,
